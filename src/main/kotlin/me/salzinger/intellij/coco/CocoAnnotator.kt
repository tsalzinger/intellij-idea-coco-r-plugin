    ...
    override fun annotate(element: PsiElement, holder: AnnotationHolder) {
        when (element) {
            is me.salzinger.intellij.coco.psi.CocoEnd -> {
                ...
                val compiler = me.salzinger.intellij.coco.CocoUtil.findCompiler(element.getContainingFile(), compilerName)
            ...
            is HasCocoCharacterReference -> {
                ...
                if (ident != null) {
                    ...
                    val characterDeclaration = me.salzinger.intellij.coco.CocoUtil.findCharacterDeclaration(element.getContainingFile(), characterReferenceName)
            ...
            is me.salzinger.intellij.coco.psi.CocoFactor -> {
                ...
                if (ident != null) {
                    ...
                    val tokenDecl = me.salzinger.intellij.coco.CocoUtil.findTokenDecl(element.getContainingFile(), referenceName)
                    val production = me.salzinger.intellij.coco.CocoUtil.findProduction(element.getContainingFile(), referenceName)
            ...
            is me.salzinger.intellij.coco.psi.CocoCompiler -> {
                ...
                if (ident != null) {
                    ...
                    val production = me.salzinger.intellij.coco.CocoUtil.findProduction(element.getContainingFile(), ident.text)
            ...
            is PsiNameIdentifierOwner -> {
                ...
                if (ident != null) {
                    ...
                    if (first == null && element is me.salzinger.intellij.coco.psi.CocoProduction) {
                        val compiler = me.salzinger.intellij.coco.CocoUtil.findCompiler(element.getContainingFile(), element.name)
                        if (compiler != null) {
