 ...
 */
class CocoStructureViewModel(file: CocoFile, editor: Editor?) :
    StructureViewModelBase(file, editor, CocoStructureViewElement(file)), StructureViewModel.ElementInfoProvider {
    ...
    override fun isAlwaysLeaf(element: StructureViewTreeElement): Boolean {
        ...
        return (
            value is me.salzinger.intellij.coco.psi.CocoSetDecl ||
